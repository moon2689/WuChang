...
{
    [CustomEditor(typeof(AbilityEventObj_PerfectDodge))]
    public class AbilityEventObj_PerfectDodgeEditor : Editor
    {
        public static AbilityEventObj_PerfectDodge CopyObj;
        public override void OnInspectorGUI()
        {
            ...
            */
            base.OnInspectorGUI();
            if (GUILayout.Button("Copy for tandao"))
            {
                CopyObj = (AbilityEventObj_PerfectDodge)target;
            }
        }
    }
}