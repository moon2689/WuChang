...
{
#if UNITY_EDITOR
    public class AbilityEventPreview_TanDao : AbilityEventPreview_CreateObjWithHandle, IColliderPreviewTarget
    {
        PreviewTransformHandle TransformHandle;
        ColliderPreviewHandle ColliderHandle;

        public AbilityEventObj_TanDao Obj => (AbilityEventObj_TanDao)m_EventObj;

        public AbilityEventPreview_TanDao(AbilityEventObj Obj) : base(Obj)
        {
            m_EventObj = Obj;
        }
