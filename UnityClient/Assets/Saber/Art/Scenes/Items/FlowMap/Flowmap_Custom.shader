...
Shader "Saber/Unlit/Flowmap_Custom"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 lerpResult41 = lerp( tex2D( _Noise, ( uv_Noise + ( FlowDir37 * ( temp_output_24_0 * _NoiseStrength ) ) ) ) ,
				tex2D( _Noise, ( uv_Noise + ( FlowDir37 * ( _NoiseStrength * frac( ( mulTime23 + 0.5 ) ) ) ) ) ) , 
				abs( (temp_output_24_0*2.0 + -1.0) ));
...
/*ASEBEGIN
Version=18500
164;230;1675;725;1413.555;-1278.698;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;3;-2698.545,811.2045;Inherit;True;Property;_FlowMap;FlowMap;4;0;Create;True;0;0;False;0;False;-1;None;913991feeeabdcf4e9fe13ce91dcf894;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;6;-2015.817,1630.795;Inherit;False;Property;_NoiseSpeed;NoiseSpeed;6;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;17;-555.2405,963.2901;Inherit;True;Property;_TextureSample5;Texture Sample 5;5;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;5;-1310.516,115.71;Inherit;False;0;4;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=21EA74AAA4A534A3ACB29C22402898AA9FAE2972