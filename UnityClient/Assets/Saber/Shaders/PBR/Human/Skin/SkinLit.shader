Shader "Saber/Human/Skin Lit"
{
    Properties
    {
        ...
        _MaskMap("Mask Map(R:Detail Normal,G:Roughness,B:Occlusion)", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                #if _CLIPBODY_ON
                half4 clipMaskMap = SAMPLE_TEXTURE2D(_ClipBodyMaskMap, sampler_ClipBodyMaskMap, input.uv);
