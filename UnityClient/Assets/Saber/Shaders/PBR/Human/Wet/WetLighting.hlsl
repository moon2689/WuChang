...
half3 GlobalIllumination_Wet(BRDFData brdfData, BRDFData brdfDataClearCoat, float clearCoatMask,
    ...
    half3 normalWS, half3 viewDirectionWS, float2 normalizedScreenSpaceUV)
{
    ...
    half fresnelTerm = max(1.0 - NoV, 0.3);

    half3 indirectDiffuse = bakedGI;
	half perceptualRoughness = 0;//brdfData.perceptualRoughness;
...
half4 UniversalFragmentPBR(InputData inputData, SurfaceData surfaceData)
{
    ...
    lightingData.giColor = GlobalIllumination_Wet(brdfData, brdfDataClearCoat, surfaceData.clearCoatMask,
