Shader "Saber/Human/Cloth Fur Lit"
{
    Properties
    {
        ...
        [Header(FurWind)]
        [Toggle] _FurWind("Fur Wind On?", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Material Keywords
            #pragma multi_compile _ _FURWIND_ON
            ...
            #include "ClothFurLitInput.hlsl"
            #include "ClothFurLitForwardPass.hlsl"
            ENDHLSL
        }
