...
SurfaceData InitializeStandardLitSurfaceData(float2 uv)
{
    ...
    half4 maskMap = SAMPLE_TEXTURE2D(_MaskMROMap, sampler_MaskMROMap, uv);
    ...
    outSurfaceData.smoothness = maskMap.g * _Roughness;
    outSurfaceData.normalTS = normalTS;
    outSurfaceData.occlusion = maskMap.a * _Occlusion;
