...
namespace Saber
{
    ...
    public static class SDebug
    {
        ...
        public static void Gizmo_Arrow(Vector3 pos, Vector3 direction, float arrowHeadLength = 0.2f,
        ...
        public static void DrawArrow(Vector3 pos, Vector3 direction, Color color, float duration = 0,
        ...
        public static void DrawCircle(Vector3 position, Vector3 normal, float radius, Color color, bool cross = false,
            float duration = 0, int steps = 36)
        {
#if UNITY_EDITOR
        ...
        public static void DrawWireSphere(Vector3 position, float radius, Color color, float drawDuration = 0,
            int Steps = 36)
            => DrawWireSphere(position, Quaternion.identity, color, radius, 1, drawDuration, Steps);

        public static void DrawWireSphere(Vector3 position, Quaternion rotation, float radius, Color color,
            float drawDuration = 0, int Steps = 36)
            => DrawWireSphere(position, rotation, color, radius, 1, drawDuration, Steps);

        public static void DrawWireSphere(Vector3 position, Quaternion rotation, Color color, float radius = 1.0f,
            float scale = 1f, float drawDuration = 0, int Steps = 36)
        {
#if UNITY_EDITOR
        ...
        public static void GizmoWireSphere(Vector3 position, Quaternion rotation, float radius, Color color,
            float scale = 1, int Steps = 36)
        {
#if UNITY_EDITOR
        ...
        public static void GizmoCircle(Vector3 position, Quaternion rotation, float radius, Color color,
            float scale = 1, int Steps = 36)
        {
#if UNITY_EDITOR
        ...
        public static void GizmoWireHemiSphere(Vector3 position, Quaternion rotation, float radius, Color color,
            float scale = 1, int Steps = 36)
        {
#if UNITY_EDITOR
        ...
        public static void DrawCone(Vector3 position, Quaternion rotation, float FOV, float length, Color color,
            float scale = 1, int Steps = 4)
        {
#if UNITY_EDITOR
            ...
            if (col != null)
                if (always || col.enabled)
                {
                    ...
                    if (col is BoxCollider)
                    {
                        ...
                        Matrix4x4 rotationMatrix = Matrix4x4.TRS(_C.bounds.center, transform.rotation,
        ...
        public static void DrawCapsule(Vector3 baseSphere, Vector3 endSphere, Color color, float radius = 1,
            float drawDuration = 0, bool drawDepth = false)

        {
            ...
            //Radial circles
            DrawCircle(baseSphere, up, radius, color, false, drawDuration);
            DrawCircle(endSphere, -up, radius, color, false, drawDuration);
            ...
            {
                //End endcap
                Debug.DrawLine(Vector3.Slerp(right, up, i / 25.0f) + endSphere,
                    Vector3.Slerp(right, up, (i - 1) / 25.0f) + endSphere, color, drawDuration,
                    drawDepth);
                Debug.DrawLine(Vector3.Slerp(-right, up, i / 25.0f) + endSphere,
                    Vector3.Slerp(-right, up, (i - 1) / 25.0f) + endSphere, color,
                    drawDuration, drawDepth);
                Debug.DrawLine(Vector3.Slerp(forward, up, i / 25.0f) + endSphere,
                    Vector3.Slerp(forward, up, (i - 1) / 25.0f) + endSphere, color,
                    drawDuration, drawDepth);
                Debug.DrawLine(Vector3.Slerp(-forward, up, i / 25.0f) + endSphere,
                    Vector3.Slerp(-forward, up, (i - 1) / 25.0f) + endSphere, color,
                    drawDuration, drawDepth);
                ...
                //Start endcap
                Debug.DrawLine(Vector3.Slerp(right, -up, i / 25.0f) + baseSphere,
                    Vector3.Slerp(right, -up, (i - 1) / 25.0f) + baseSphere,
                    color, drawDuration, drawDepth);
                Debug.DrawLine(Vector3.Slerp(-right, -up, i / 25.0f) + baseSphere,
                    Vector3.Slerp(-right, -up, (i - 1) / 25.0f) + baseSphere,
                    color, drawDuration, drawDepth);
                Debug.DrawLine(Vector3.Slerp(forward, -up, i / 25.0f) + baseSphere,
                    Vector3.Slerp(forward, -up, (i - 1) / 25.0f) + baseSphere,
                    color, drawDuration, drawDepth);
                Debug.DrawLine(Vector3.Slerp(-forward, -up, i / 25.0f) + baseSphere,
                    Vector3.Slerp(-forward, -up, (i - 1) / 25.0f) + baseSphere,
                    color, drawDuration, drawDepth);
