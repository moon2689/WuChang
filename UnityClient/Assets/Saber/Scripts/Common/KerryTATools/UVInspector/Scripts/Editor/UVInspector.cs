...
namespace nTools.UVInspector
{
    ...
    public class UVInspector : EditorWindow
    {
        ...
        {            
            ...
            {                
                ...
                for (int i = 0; i < objectCount; i++)
                {
                    ...
                    {
                        UnityEngine.Debug.LogWarning("UVSnapshot: object \"" + m_Inspector.m_InspectedObjects[i].gameObject.name + "\" has unassigned UV channel " + m_Inspector.m_PreviewUVSet.ToString());
                        continue;
                    }
        ...
        void OnEnable () 
        {
            ...
            if(!LoadMaterials())
            {
                UnityEngine.Debug.LogWarning("UV Inspector Error: shaders not found. Reimport asset.");
                Close();
                return;
            }
