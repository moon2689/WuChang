...
public class AssetAnalysisWindow : EditorWindow
{
    ...
    private Dictionary<Object, long> m_objDic;
    private Dictionary<Object, Dictionary<Object, long>> m_referenceDic;
    ...
    private void DoAssetAnalyse(string path)
    {
        ...
        if (_prefab != null)
        {
            ...
            var refList = new Dictionary<Object, long>();
            long sumSize = 0;
            foreach (var obj in dependencies)
            {
                ...
                if (tex)
                {
                    long memSize = UnityEngine.Profiling.Profiler.GetRuntimeMemorySizeLong(tex) / 2;
                    sumSize += memSize;
    ...
    {
        m_objDic = new Dictionary<Object, long>();
        m_referenceDic = new Dictionary<Object, Dictionary<Object, long>>();
    }
