	...
	public class FR2_Export
	{
		...
		public static void ExportCSV(FR2_Ref[] csvSource)
		{
			...
			if (result.Length > 0)
			{
				...
				UnityEngine.Debug.Log("[FR2] CSV file content (" + csvSource.Length + " assets) copied to clipboard!");
			}
			else
			{
				UnityEngine.Debug.LogWarning("[FR2] Nothing to export!");
			}
		}
		...
		private static void Ignore()
		{
			...
			{
				UnityEngine.Debug.LogWarning("FR2 cache not yet ready, please open Window > FR2_Window and hit scan project!");
				return;
			}
		...
		public static void MergeDuplicate(string guid_file)
		{
			...
			{
				UnityEngine.Debug.LogWarning("Invalid guid <" + guid + "> in clipboard, can not replace !");
				return;
			}
			...
			{
				UnityEngine.Debug.LogWarning("Clipboard guid <" + guid +
...
//				}
			...
			{
				UnityEngine.Debug.LogWarning("No new asset selected to replace, must select all duplications to replace");
				return;
			}
