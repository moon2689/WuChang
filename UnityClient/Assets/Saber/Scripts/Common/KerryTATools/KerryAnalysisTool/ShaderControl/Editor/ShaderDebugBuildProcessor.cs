    ...
    class ShaderDebugBuildProcessor : IPreprocessShaders, IPostprocessBuildWithReport {
        ...
        void SaveResults() {
            ...
            if (shadersBuildInfo != null) {
                ...
                string filename = GetStoredDataPath();
                if (filename == null) {
                    UnityEngine.Debug.LogError("Shader Control path not found.");
                } else {
                    AssetDatabase.SaveAssets();
                }
            }
        ...
        public void OnProcessShader(
            ...
            try {
                ...
                UnityEngine.Debug.LogWarning("Shader Control detected an error during compilation of one shader: " + ex.ToString());
            }
