    ...
    public partial class SCWindow : EditorWindow {
        ...
        void CleanAllMaterials() {
            ...
            try {
                ...
                ScanProject();
                UnityEngine.Debug.Log("Cleaning finished.");
            } catch (Exception ex) {
                UnityEngine.Debug.LogError("Unexpected exception caught while cleaning materials: " + ex.Message);
            }
        }
        ...
        void PruneMaterials(string keywordName) {
            try {
                ...
                UnityEngine.Debug.Log("Unexpected exception caught while pruning materials: " + ex.Message);
            }
