    ...
    public partial class SCWindow : EditorWindow {
        ...
        void ScanProject() {
            try {
                ...
                UnityEngine.Debug.LogError("Unexpected exception caught while scanning project: " + ex.Message);
            }
        }
        ...
        void ScanShader(SCShader shader) {
            ...
            if (shader.path.EndsWith(".shadergraph")) {
                ...
                try {
                    ...
                    UnityEngine.Debug.LogError("Couldn't analyze shader graph at " + shader.path + ". Error found: " + ex.ToString());
                }
            } else {
                try {
                    ScanShaderNonGraph(shader);
                } catch (Exception ex) {
                    UnityEngine.Debug.LogError("Couldn't analyze shader at " + shader.path + ". Error found: " + ex.ToString());
                }
            }
        }
        ...
        void UpdateShader(SCShader shader) {
            ...
            try {
                ...
                UnityEngine.Debug.LogError("Unexpected exception caught while updating shader: " + ex.Message);
            }
        }
        ...
        void RestoreShader(SCShader shader) {
            try {
                ...
                UnityEngine.Debug.LogError("Unexpected exception caught while restoring shader: " + ex.Message);
            }
        }
        ...
        void DeleteShader(SCShader shader) {
            try {
                ...
                UnityEngine.Debug.LogError("Unexpected exception caught while deleting shader: " + ex.Message);
            }
        }
