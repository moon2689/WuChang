			...
			for (var i = 0; i < source.subMeshCount; i++)
			{
				...
				if (DebugScale > 0.0f)
				{
					for (var j = edges.Count - 1; j >= 0; j--)
					{
						...
						if (edge.Used == true)
						{
							UnityEngine.Debug.DrawLine(edge.CoordA * DebugScale, edge.CoordB * DebugScale, new Color(1.0f, 1.0f, 1.0f, 0.5f), 1.0f);
						}
						else
						{
							UnityEngine.Debug.DrawLine(edge.CoordA * DebugScale, edge.CoordB * DebugScale, new Color(1.0f, 1.0f, 1.0f, 0.25f), 1.0f);
						}
					}
				}
				...
				for (var i = 0; i < points.Count - 3; i++)
				{
					...
					if (DebugScale > 0.0f)
					{
						switch (channel)
						{
							case P3dChannel.UV:
							{
								UnityEngine.Debug.DrawLine(coords0[a] * DebugScale, coords0[b] * DebugScale, Color.green, 1.0f);
								UnityEngine.Debug.DrawLine(coords0[c] * DebugScale, coords0[d] * DebugScale, Color.blue , 1.0f);
							}
							break;

							case P3dChannel.UV2:
							{
								UnityEngine.Debug.DrawLine(coords1[a] * DebugScale, coords1[b] * DebugScale, Color.green, 1.0f);
								UnityEngine.Debug.DrawLine(coords1[c] * DebugScale, coords1[d] * DebugScale, Color.blue , 1.0f);
							}
							break;

							case P3dChannel.UV3:
							{
								UnityEngine.Debug.DrawLine(coords2[a] * DebugScale, coords2[b] * DebugScale, Color.green, 1.0f);
								UnityEngine.Debug.DrawLine(coords2[c] * DebugScale, coords2[d] * DebugScale, Color.blue , 1.0f);
							}
							break;

							case P3dChannel.UV4:
							{
								UnityEngine.Debug.DrawLine(coords3[a] * DebugScale, coords3[b] * DebugScale, Color.green, 1.0f);
								UnityEngine.Debug.DrawLine(coords3[c] * DebugScale, coords3[d] * DebugScale, Color.blue , 1.0f);
							}
							break;
						}
					}
